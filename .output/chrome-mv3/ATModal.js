var atmodal = function() {
  ...
  const AIModal = ({ onClose, onInsert }) => {
    const [messages, setMessages] = reactExports.useState([]);
    const [inputValue, setInputValue] = reactExports.useState("");
    const [isRegenerate, setIsRegenerate] = reactExports.useState(false);
    const handleGenerate = () => {
      const userMessage = { type: "question", text: inputValue };
      const aiResponse = {
        type: "answer",
    ...
    return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "fixed inset-0 flex items-center justify-center z-[9999] bg-gray-900 bg-opacity-50", children: [
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "bg-white p-6 rounded-lg shadow-lg z-40 w-[500px] max-h-[80vh] flex flex-col", children: [
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "overflow-y-auto max-h-[400px] min-h-[100px] flex-grow", children: messages.map((message, index) => /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
          "div",
          {
            className: `my-2 p-2 rounded ${message.type === "question" ? "bg-blue-100 text-right" : "bg-gray-100 text-left"}`,
            children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("p", { children: message.text }, void 0, false, {
              fileName: "C:/Users/v-fpathikkal/Documents/personal/extension-linkdin/Linkedin-Extension/entrypoints/ATModal.tsx",
              lineNumber: 41,
              columnNumber: 15
            }, void 0)
          },
        ...
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "mt-4 flex justify-end text-2xl font-semibold", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                "img",
                {
                  src: `${browser.runtime.getURL(isRegenerate ? "icon/regenerate-icon.svg" : "icon/Arrow-icon.svg")}`,
        ...
        messages.length > 0 && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
          "button",
          {
            onClick: () => {
      ...
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "absolute inset-0 z-10", onClick: onClose }, void 0, false, {
        fileName: "C:/Users/v-fpathikkal/Documents/personal/extension-linkdin/Linkedin-Extension/entrypoints/ATModal.tsx",
        lineNumber: 86,
        columnNumber: 7
      }, void 0)
  ...
  const result = (async () => {
    try {
      initPlugins();
      return await AIModal.main();
    } catch (err) {
      logger.error(
        `The unlisted script "${"ATModal"}" crashed on startup!`,
        err
      );
      throw err;
    }
